...
DEFAULT_R_QUENCH_PARAMS = OrderedDict(
    R_Fquench=0.718,
    R_ulgm_quench_ylo=-1.236,
    R_ulgm_quench_yhi=0.334,
    R_ulgy_quench_ylo=0.225,
    R_ulgy_quench_yhi=-0.480,
    R_ul_quench_ylo=5.082,
    R_ul_quench_yhi=-4.851,
    R_utau_quench_ylo=4.391,
    R_utau_quench_yhi=-7.901,
    R_uqt_quench_ylo=-0.034,
    R_uqt_quench_yhi=0.327,
    R_uqs_quench_ylo=2.550,
    R_uqs_quench_yhi=-2.556,
    R_udrop_quench_ylo=0.516,
    R_udrop_quench_yhi=-0.585,
    R_urej_quench_ylo=1.300,
    R_urej_quench_yhi=-0.762,
)
DEFAULT_R_MAINSEQ_PARAMS = OrderedDict(
    R_ulgm_mainseq_ylo=-0.856,
    R_ulgm_mainseq_yhi=0.097,
    R_ulgy_mainseq_ylo=-0.828,
    R_ulgy_mainseq_yhi=2.039,
    R_ul_mainseq_ylo=5.093,
    R_ul_mainseq_yhi=-3.381,
    R_utau_mainseq_ylo=4.421,
    R_utau_mainseq_yhi=-6.735,
)
