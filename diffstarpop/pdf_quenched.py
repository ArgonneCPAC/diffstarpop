...
DEFAULT_SFH_PDF_QUENCH_PARAMS = OrderedDict(
    frac_quench_x0=11.950,
    frac_quench_k=1.525,
    frac_quench_ylo=-0.822,
    frac_quench_yhi=2.071,
    mean_ulgm_quench_ylo=11.650,
    mean_ulgm_quench_yhi=12.210,
    mean_ulgy_quench_ylo=-0.046,
    mean_ulgy_quench_yhi=-0.623,
    mean_ul_quench_ylo=-0.760,
    mean_ul_quench_yhi=2.187,
    mean_utau_quench_ylo=56.630,
    mean_utau_quench_yhi=-65.570,
    mean_uqt_quench_ylo=1.699,
    mean_uqt_quench_yhi=-0.020,
    mean_uqs_quench_ylo=-3.216,
    mean_uqs_quench_yhi=2.403,
    mean_udrop_quench_ylo=-0.534,
    mean_udrop_quench_yhi=-3.624,
    mean_urej_quench_ylo=2.038,
    mean_urej_quench_yhi=-3.941,
    chol_ulgm_ulgm_quench_ylo=-1.508,
    chol_ulgm_ulgm_quench_yhi=0.427,
    chol_ulgy_ulgy_quench_ylo=-1.066,
    chol_ulgy_ulgy_quench_yhi=-0.451,
    chol_ul_ul_quench_ylo=-0.580,
    chol_ul_ul_quench_yhi=0.605,
    chol_utau_utau_quench_ylo=0.844,
    chol_utau_utau_quench_yhi=0.998,
    chol_uqt_uqt_quench_ylo=-1.354,
    chol_uqt_uqt_quench_yhi=-0.897,
    chol_uqs_uqs_quench_ylo=-0.392,
    chol_uqs_uqs_quench_yhi=-0.576,
    chol_udrop_udrop_quench_ylo=-0.708,
    chol_udrop_udrop_quench_yhi=-0.702,
    chol_urej_urej_quench_ylo=0.912,
    chol_urej_urej_quench_yhi=-1.187,
    chol_ulgy_ulgm_quench_ylo=-1.160,
    chol_ulgy_ulgm_quench_yhi=-1.243,
    chol_ul_ulgm_quench_ylo=0.496,
    chol_ul_ulgm_quench_yhi=0.673,
    chol_ul_ulgy_quench_ylo=0.471,
    chol_ul_ulgy_quench_yhi=0.271,
    chol_utau_ulgm_quench_ylo=-0.264,
    chol_utau_ulgm_quench_yhi=0.134,
    chol_utau_ulgy_quench_ylo=0.666,
    chol_utau_ulgy_quench_yhi=0.750,
    chol_utau_ul_quench_ylo=-0.640,
    chol_utau_ul_quench_yhi=-0.784,
    chol_uqt_ulgm_quench_ylo=0.603,
    chol_uqt_ulgm_quench_yhi=0.674,
    chol_uqt_ulgy_quench_ylo=0.075,
    chol_uqt_ulgy_quench_yhi=0.016,
    chol_uqt_ul_quench_ylo=-0.005,
    chol_uqt_ul_quench_yhi=-0.223,
    chol_uqt_utau_quench_ylo=0.207,
    chol_uqt_utau_quench_yhi=0.090,
    chol_uqs_ulgm_quench_ylo=0.860,
    chol_uqs_ulgm_quench_yhi=0.975,
    chol_uqs_ulgy_quench_ylo=0.791,
    chol_uqs_ulgy_quench_yhi=0.801,
    chol_uqs_ul_quench_ylo=0.344,
    chol_uqs_ul_quench_yhi=0.356,
    chol_uqs_utau_quench_ylo=-0.184,
    chol_uqs_utau_quench_yhi=0.081,
    chol_uqs_uqt_quench_ylo=-0.313,
    chol_uqs_uqt_quench_yhi=-0.285,
    chol_udrop_ulgm_quench_ylo=-0.963,
    chol_udrop_ulgm_quench_yhi=-0.989,
    chol_udrop_ulgy_quench_ylo=-0.735,
    chol_udrop_ulgy_quench_yhi=-0.749,
    chol_udrop_ul_quench_ylo=-0.051,
    chol_udrop_ul_quench_yhi=0.098,
    chol_udrop_utau_quench_ylo=0.315,
    chol_udrop_utau_quench_yhi=0.234,
    chol_udrop_uqt_quench_ylo=0.931,
    chol_udrop_uqt_quench_yhi=1.072,
    chol_udrop_uqs_quench_ylo=0.595,
    chol_udrop_uqs_quench_yhi=0.693,
    chol_urej_ulgm_quench_ylo=-0.221,
    chol_urej_ulgm_quench_yhi=-0.239,
    chol_urej_ulgy_quench_ylo=-0.812,
    chol_urej_ulgy_quench_yhi=-0.789,
    chol_urej_ul_quench_ylo=-0.165,
    chol_urej_ul_quench_yhi=0.384,
    chol_urej_utau_quench_ylo=0.404,
    chol_urej_utau_quench_yhi=-0.452,
    chol_urej_uqt_quench_ylo=-0.741,
    chol_urej_uqt_quench_yhi=-0.495,
    chol_urej_uqs_quench_ylo=1.035,
    chol_urej_uqs_quench_yhi=1.086,
    chol_urej_udrop_quench_ylo=-0.766,
    chol_urej_udrop_quench_yhi=-0.925,
)
