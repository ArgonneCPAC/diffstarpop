...
DEFAULT_SFH_PDF_QUENCH_PARAMS = OrderedDict(
    frac_quench_x0=11.930,
    frac_quench_k=1.587,
    frac_quench_ylo=-0.836,
    frac_quench_yhi=2.060,
    mean_ulgm_quench_ylo=11.570,
    mean_ulgm_quench_yhi=12.230,
    mean_ulgy_quench_ylo=-0.051,
    mean_ulgy_quench_yhi=-0.643,
    mean_ul_quench_ylo=-0.733,
    mean_ul_quench_yhi=2.160,
    mean_utau_quench_ylo=56.380,
    mean_utau_quench_yhi=-65.680,
    mean_uqt_quench_ylo=1.670,
    mean_uqt_quench_yhi=0.012,
    mean_uqs_quench_ylo=-3.220,
    mean_uqs_quench_yhi=2.449,
    mean_udrop_quench_ylo=-0.628,
    mean_udrop_quench_yhi=-3.609,
    mean_urej_quench_ylo=1.966,
    mean_urej_quench_yhi=-3.890,
    chol_ulgm_ulgm_quench_ylo=-1.521,
    chol_ulgm_ulgm_quench_yhi=0.473,
    chol_ulgy_ulgy_quench_ylo=-0.967,
    chol_ulgy_ulgy_quench_yhi=-0.316,
    chol_ul_ul_quench_ylo=-0.642,
    chol_ul_ul_quench_yhi=0.553,
    chol_utau_utau_quench_ylo=0.820,
    chol_utau_utau_quench_yhi=0.988,
    chol_uqt_uqt_quench_ylo=-1.277,
    chol_uqt_uqt_quench_yhi=-0.998,
    chol_uqs_uqs_quench_ylo=-0.456,
    chol_uqs_uqs_quench_yhi=-0.632,
    chol_udrop_udrop_quench_ylo=-0.775,
    chol_udrop_udrop_quench_yhi=-0.697,
    chol_urej_urej_quench_ylo=1.011,
    chol_urej_urej_quench_yhi=-1.309,
    chol_ulgy_ulgm_quench_ylo=-1.379,
    chol_ulgy_ulgm_quench_yhi=-1.605,
    chol_ul_ulgm_quench_ylo=0.513,
    chol_ul_ulgm_quench_yhi=0.760,
    chol_ul_ulgy_quench_ylo=0.363,
    chol_ul_ulgy_quench_yhi=0.045,
    chol_utau_ulgm_quench_ylo=-0.595,
    chol_utau_ulgm_quench_yhi=-0.098,
    chol_utau_ulgy_quench_ylo=0.469,
    chol_utau_ulgy_quench_yhi=0.573,
    chol_utau_ul_quench_ylo=-0.689,
    chol_utau_ul_quench_yhi=-0.859,
    chol_uqt_ulgm_quench_ylo=0.702,
    chol_uqt_ulgm_quench_yhi=0.613,
    chol_uqt_ulgy_quench_ylo=0.031,
    chol_uqt_ulgy_quench_yhi=0.095,
    chol_uqt_ul_quench_ylo=-0.002,
    chol_uqt_ul_quench_yhi=-0.264,
    chol_uqt_utau_quench_ylo=0.252,
    chol_uqt_utau_quench_yhi=0.055,
    chol_uqs_ulgm_quench_ylo=0.801,
    chol_uqs_ulgm_quench_yhi=0.993,
    chol_uqs_ulgy_quench_ylo=0.985,
    chol_uqs_ulgy_quench_yhi=1.020,
    chol_uqs_ul_quench_ylo=0.378,
    chol_uqs_ul_quench_yhi=0.440,
    chol_uqs_utau_quench_ylo=-0.164,
    chol_uqs_utau_quench_yhi=0.062,
    chol_uqs_uqt_quench_ylo=-0.194,
    chol_uqs_uqt_quench_yhi=-0.205,
    chol_udrop_ulgm_quench_ylo=-1.177,
    chol_udrop_ulgm_quench_yhi=-1.253,
    chol_udrop_ulgy_quench_ylo=-1.426,
    chol_udrop_ulgy_quench_yhi=-1.411,
    chol_udrop_ul_quench_ylo=-0.129,
    chol_udrop_ul_quench_yhi=-0.106,
    chol_udrop_utau_quench_ylo=0.312,
    chol_udrop_utau_quench_yhi=0.331,
    chol_udrop_uqt_quench_ylo=1.482,
    chol_udrop_uqt_quench_yhi=2.011,
    chol_udrop_uqs_quench_ylo=0.723,
    chol_udrop_uqs_quench_yhi=0.431,
    chol_urej_ulgm_quench_ylo=-0.164,
    chol_urej_ulgm_quench_yhi=-0.216,
    chol_urej_ulgy_quench_ylo=-1.125,
    chol_urej_ulgy_quench_yhi=-1.175,
    chol_urej_ul_quench_ylo=-0.156,
    chol_urej_ul_quench_yhi=0.576,
    chol_urej_utau_quench_ylo=0.437,
    chol_urej_utau_quench_yhi=-0.548,
    chol_urej_uqt_quench_ylo=-1.025,
    chol_urej_uqt_quench_yhi=-0.473,
    chol_urej_uqs_quench_ylo=1.229,
    chol_urej_uqs_quench_yhi=1.326,
    chol_urej_udrop_quench_ylo=-0.873,
    chol_urej_udrop_quench_yhi=-1.431,
)
