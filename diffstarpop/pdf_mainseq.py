...
DEFAULT_SFH_PDF_MAINSEQ_PARAMS = OrderedDict(
    mean_ulgm_mainseq_ylo=10.130,
    mean_ulgm_mainseq_yhi=14.750,
    mean_ulgy_mainseq_ylo=-2.348,
    mean_ulgy_mainseq_yhi=1.582,
    mean_ul_mainseq_ylo=-6.058,
    mean_ul_mainseq_yhi=10.010,
    mean_utau_mainseq_ylo=48.170,
    mean_utau_mainseq_yhi=-56.500,
    chol_ulgm_ulgm_mainseq_ylo=-0.888,
    chol_ulgm_ulgm_mainseq_yhi=0.151,
    chol_ulgy_ulgy_mainseq_ylo=-0.572,
    chol_ulgy_ulgy_mainseq_yhi=-0.234,
    chol_ul_ul_mainseq_ylo=1.401,
    chol_ul_ul_mainseq_yhi=-2.121,
    chol_utau_utau_mainseq_ylo=-0.729,
    chol_utau_utau_mainseq_yhi=1.517,
    chol_ulgy_ulgm_mainseq_ylo=-1.171,
    chol_ulgy_ulgm_mainseq_yhi=-1.691,
    chol_ul_ulgm_mainseq_ylo=0.049,
    chol_ul_ulgm_mainseq_yhi=0.018,
    chol_ul_ulgy_mainseq_ylo=0.396,
    chol_ul_ulgy_mainseq_yhi=0.326,
    chol_utau_ulgm_mainseq_ylo=-0.218,
    chol_utau_ulgm_mainseq_yhi=0.172,
    chol_utau_ulgy_mainseq_ylo=-0.438,
    chol_utau_ulgy_mainseq_yhi=-0.609,
    chol_utau_ul_mainseq_ylo=-0.848,
    chol_utau_ul_mainseq_yhi=-0.434,
)
