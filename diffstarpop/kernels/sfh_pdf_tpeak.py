...
SFH_PDF_QUENCH_MU_PDICT = OrderedDict(
    mean_lgmhalo_x0=13.210,
    mean_ulgm_ms_ylo=11.845,
    mean_ulgm_ms_yhi=11.102,
    mean_ulgy_ms_ylo=-0.563,
    mean_ulgy_ms_yhi=2.371,
    mean_ul_ms_ylo=0.582,
    mean_ul_ms_yhi=-4.978,
    mean_utau_ms_ylo=8.276,
    mean_utau_ms_yhi=-12.153,
    mean_ulgm_quench_ylo=12.144,
    mean_ulgm_quench_yhi=12.354,
    mean_ulgy_quench_ylo=5.269,
    mean_ulgy_quench_yhi=-0.731,
    mean_ul_quench_ylo=-0.323,
    mean_ul_quench_yhi=0.436,
    mean_utau_quench_ylo=11.095,
    mean_utau_quench_yhi=-0.671,
    mean_uqt_quench_ylo=0.860,
    mean_uqt_quench_yhi=0.208,
    mean_uqs_quench_ylo=-1.549,
    mean_uqs_quench_yhi=0.829,
    mean_udrop_quench_ylo=-2.932,
    mean_udrop_quench_yhi=-0.748,
    mean_urej_quench_ylo=0.242,
    mean_urej_quench_yhi=-9.176,
)
...
SFH_PDF_QUENCH_COV_MS_BLOCK_PDICT = OrderedDict(
    std_ulgm_quench_ylo=0.230,
    std_ulgm_quench_yhi=0.219,
    std_ulgy_quench_ylo=0.315,
    std_ulgy_quench_yhi=0.129,
    std_ul_quench_ylo=0.397,
    std_ul_quench_yhi=0.269,
    std_utau_quench_ylo=2.092,
    std_utau_quench_yhi=2.642,
    rho_ulgy_ulgm_quench_ylo=0.103,
    rho_ulgy_ulgm_quench_yhi=-0.277,
    rho_ul_ulgm_quench_ylo=-0.182,
    rho_ul_ulgm_quench_yhi=-0.275,
    rho_ul_ulgy_quench_ylo=0.250,
    rho_ul_ulgy_quench_yhi=0.226,
    rho_utau_ulgm_quench_ylo=-0.248,
    rho_utau_ulgm_quench_yhi=0.278,
    rho_utau_ulgy_quench_ylo=0.280,
    rho_utau_ulgy_quench_yhi=0.285,
    rho_utau_ul_quench_ylo=-0.291,
    rho_utau_ul_quench_yhi=0.049,
)
...
SFH_PDF_QUENCH_COV_Q_BLOCK_PDICT = OrderedDict(
    std_uqt_quench_ylo=0.077,
    std_uqt_quench_yhi=0.069,
    std_uqs_quench_ylo=0.056,
    std_uqs_quench_yhi=0.683,
    std_udrop_quench_ylo=0.078,
    std_udrop_quench_yhi=0.405,
    std_urej_quench_ylo=0.067,
    std_urej_quench_yhi=0.674,
    rho_uqs_uqt_quench_ylo=0.170,
    rho_uqs_uqt_quench_yhi=0.118,
    rho_udrop_uqt_quench_ylo=-0.109,
    rho_udrop_uqt_quench_yhi=0.043,
    rho_udrop_uqs_quench_ylo=-0.066,
    rho_udrop_uqs_quench_yhi=-0.075,
    rho_urej_uqt_quench_ylo=-0.235,
    rho_urej_uqt_quench_yhi=-0.080,
    rho_urej_uqs_quench_ylo=0.265,
    rho_urej_uqs_quench_yhi=0.265,
    rho_urej_udrop_quench_ylo=0.049,
    rho_urej_udrop_quench_yhi=0.043,
)
...
SFH_PDF_FRAC_QUENCH_PDICT = OrderedDict(
    frac_quench_x0=11.847,
    frac_quench_k=1.297,
    frac_quench_ylo=-0.186,
    frac_quench_yhi=0.860,
)
