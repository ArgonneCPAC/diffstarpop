...
@jjit
def mc_diffstar_u_params_singlegal_quenched_kernel(
    qs_mass_params,
    ab_qs_params,
    mah_params,
    p50,
    ...
    mu_qs, cov_qs = _diffstarpop_pdf_quenched_params(
        qs_mass_params,
        ab_qs_params,
        mah_params,
        p50,
...
def mc_diffstar_u_params_singlegal_mainseq_kernel(
    ...
    mu_ms, cov_ms = _diffstarpop_pdf_mainseq_params(
        ms_mass_params,
        ab_ms_params,
        mah_params,
        p50,
...
@jjit
def _diffstarpop_pdf_quenched_params(
    qs_mass_params,
    ab_qs_params,
    mah_params,
    p50,
...
@jjit
def _diffstarpop_pdf_mainseq_params(
    ms_mass_params,
    ab_ms_params,
    mah_params,
    p50,
...
@jjit
def mc_diffstar_u_params_uniform_draw_singlegal_kernel(
    ms_mass_params,
    qs_mass_params,
    ab_ms_params,
    ab_qs_params,
