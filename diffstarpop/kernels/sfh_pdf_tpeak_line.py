...
SFH_PDF_QUENCH_COV_MS_BLOCK_PDICT = OrderedDict(
    ...
    std_utau_int=6.85,
    std_utau_slp=0.96,
    rho_ulgy_ulgm_int=0.01,
    rho_ulgy_ulgm_slp=0.01,
    rho_ul_ulgm_int=0.01,
    rho_ul_ulgm_slp=0.01,
    rho_ul_ulgy_int=0.01,
    rho_ul_ulgy_slp=0.01,
    rho_utau_ulgm_int=0.01,
    rho_utau_ulgm_slp=0.01,
    rho_utau_ulgy_int=0.01,
    rho_utau_ulgy_slp=0.01,
    rho_utau_ul_int=0.01,
    rho_utau_ul_slp=0.01,
)
...
SFH_PDF_QUENCH_COV_Q_BLOCK_PDICT = OrderedDict(
    ...
    std_urej_int=1.12,
    std_urej_slp=-0.26,
    rho_uqs_uqt_int=0.01,
    rho_uqs_uqt_slp=0.01,
    rho_udrop_uqt_int=0.01,
    rho_udrop_uqt_slp=0.01,
    rho_udrop_uqs_int=0.01,
    rho_udrop_uqs_slp=0.01,
    rho_urej_uqt_int=0.01,
    rho_urej_uqt_slp=0.01,
    rho_urej_uqs_int=0.01,
    rho_urej_uqs_slp=0.01,
    rho_urej_udrop_int=0.01,
    rho_urej_udrop_slp=0.01,
)
