...
from ....loss_kernels.namedtuple_utils_tpeak_sepms_satfrac_sigslope_tpeak import (
    tuple_to_array,
)
...
# SMDPL
from ..params_diffstarfits_line_sepms_satfrac_sigslope_tpeak_smdpl import (
    DIFFSTARFITS_SMDPL_DIFFSTARPOP_PARAMS as PARAMS_SMDPL,
    DIFFSTARFITS_SMDPL_DIFFSTARPOP_U_PARAMS as U_PARAMS_SMDPL,
)

# SMDPL DR1
from ..params_diffstarfits_line_sepms_satfrac_sigslope_tpeak_smdpl_DR1 import (
...
# TNG
from ..params_diffstarfits_line_sepms_satfrac_sigslope_tpeak_tng import (
    DIFFSTARFITS_TNG_DIFFSTARPOP_PARAMS as PARAMS_TNG,
    DIFFSTARFITS_TNG_DIFFSTARPOP_U_PARAMS as U_PARAMS_TNG,
)

# Galacticus IN
from ..params_diffstarfits_line_sepms_satfrac_sigslope_tpeak_galacticus_in_situ import (
...
# Galacticus INPLUSEX
from ..params_diffstarfits_line_sepms_satfrac_sigslope_tpeak_galacticus_in_plus_ex_situ import (
...
def test_allsims():
    for sim_name in sim_name_list:
        _params = DiffstarPop_Params_Diffstarfits_line_sepms_satfrac_sigslope_tpeak[
            sim_name
        ]
        _uparams = DiffstarPop_UParams_Diffstarfits_line_sepms_satfrac_sigslope_tpeak[
            sim_name
        ]
