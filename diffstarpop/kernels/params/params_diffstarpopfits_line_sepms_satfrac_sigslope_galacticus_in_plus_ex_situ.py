...
_U_PNAMES = ['u_' + key for key in DIFFSTARPOP_FITS_GALACTICUS_INPLUSEX_DIFFSTARPOP_PARAMS._fields]
DiffstarPopUParams = namedtuple('DiffstarPopUParams', _U_PNAMES)

DIFFSTARPOP_FITS_GALACTICUS_INPLUSEX_DIFFSTARPOP_U_PARAMS = get_unbounded_diffstarpop_params(
