...
from ..defaults_tpeak_line_sepms_satfrac_sigslope import get_unbounded_diffstarpop_params

SFH_PDF_QUENCH_MU_PDICT = OrderedDict([
    ('mean_ulgm_mseq_xtp', 11.856),
    ('mean_ulgm_mseq_ytp', 10.680),
    ('mean_ulgm_mseq_lo', 6.535),
    ('mean_ulgm_mseq_hi', 0.545),
    ...
    ('mean_ulgm_qseq_xtp', 12.146),
    ('mean_ulgm_qseq_ytp', 11.353),
    ('mean_ulgm_qseq_lo', 1.388),
    ('mean_ulgm_qseq_hi', 0.224),
