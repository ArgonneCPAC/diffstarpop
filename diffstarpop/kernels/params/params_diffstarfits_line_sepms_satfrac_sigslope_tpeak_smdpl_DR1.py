...
SFH_PDF_QUENCH_MU_PDICT = OrderedDict(
    [
        ("mean_ulgm_mseq_xtp", 11.785),
        ("mean_ulgm_mseq_ytp", 11.870),
        ("mean_ulgm_mseq_lo", 1.680),
        ("mean_ulgm_mseq_hi", 0.195),
        ...
        ("mean_ulgm_qseq_xtp", 12.066),
        ("mean_ulgm_qseq_ytp", 12.062),
        ("mean_ulgm_qseq_lo", 1.321),
        ("mean_ulgm_qseq_hi", 0.132),
...
SFH_PDF_FRAC_QUENCH_PDICT = OrderedDict(
    [
        ...
        ("frac_quench_cen_x0_ylotpeak", 12.883),
        ("frac_quench_cen_x0_yhitpeak", 11.965),
        ("frac_quench_cen_ylo_ylotpeak", 0.487),
        ...
        ("frac_quench_sat_x0_ylotpeak", 12.883),
        ("frac_quench_sat_x0_yhitpeak", 11.965),
        ("frac_quench_sat_ylo_ylotpeak", 0.487),
