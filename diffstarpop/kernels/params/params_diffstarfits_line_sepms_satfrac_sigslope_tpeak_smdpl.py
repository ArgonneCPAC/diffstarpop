...
SFH_PDF_QUENCH_MU_PDICT = OrderedDict(
    [
        ("mean_ulgm_mseq_xtp", 12.544),
        ("mean_ulgm_mseq_ytp", 12.210),
        ("mean_ulgm_mseq_lo", 0.602),
        ("mean_ulgm_mseq_hi", -0.481),
...
SFH_PDF_FRAC_QUENCH_PDICT = OrderedDict(
    [
        ...
        ("frac_quench_cen_x0_ylotpeak", 12.998),
        ("frac_quench_cen_x0_yhitpeak", 12.028),
        ("frac_quench_cen_ylo_ylotpeak", 0.666),
        ...
        ("frac_quench_sat_x0_ylotpeak", 12.998),
        ("frac_quench_sat_x0_yhitpeak", 12.028),
        ("frac_quench_sat_ylo_ylotpeak", 0.666),
