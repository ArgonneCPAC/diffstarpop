...
SFH_PDF_QUENCH_MU_PDICT = OrderedDict([
    ('mean_ulgm_mseq_xtp', 11.780),
    ('mean_ulgm_mseq_ytp', 11.866),
    ('mean_ulgm_mseq_lo', 1.704),
    ('mean_ulgm_mseq_hi', 0.197),
    ...
    ('mean_ulgm_qseq_xtp', 12.064),
    ('mean_ulgm_qseq_ytp', 12.061),
    ('mean_ulgm_qseq_lo', 1.330),
    ('mean_ulgm_qseq_hi', 0.133),
