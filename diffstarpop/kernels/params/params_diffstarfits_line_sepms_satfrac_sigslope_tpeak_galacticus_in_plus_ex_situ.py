...
SFH_PDF_QUENCH_MU_PDICT = OrderedDict(
    [
        ("mean_ulgm_mseq_xtp", 12.299),
        ("mean_ulgm_mseq_ytp", 11.300),
        ("mean_ulgm_mseq_lo", 3.119),
        ("mean_ulgm_mseq_hi", 0.280),
        ...
        ("mean_ulgm_qseq_xtp", 12.291),
        ("mean_ulgm_qseq_ytp", 11.300),
        ("mean_ulgm_qseq_lo", 3.285),
        ("mean_ulgm_qseq_hi", 0.398),
...
SFH_PDF_FRAC_QUENCH_PDICT = OrderedDict(
    [
        ...
        ("frac_quench_cen_x0_ylotpeak", 11.669),
        ("frac_quench_cen_x0_yhitpeak", 12.861),
        ("frac_quench_cen_ylo_ylotpeak", 0.368),
        ("frac_quench_cen_ylo_yhitpeak", 0.140),
        ("frac_quench_cen_k", 3.848),
        ("frac_quench_cen_yhi", 0.971),
        ("frac_quench_sat_x0_tpeak", 7.000),
        ("frac_quench_sat_k_tpeak", 2.000),
        ("frac_quench_sat_x0_ylotpeak", 11.669),
        ("frac_quench_sat_x0_yhitpeak", 12.861),
        ("frac_quench_sat_ylo_ylotpeak", 0.368),
        ("frac_quench_sat_ylo_yhitpeak", 0.140),
