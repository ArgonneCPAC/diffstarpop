...
SFH_PDF_FRAC_QUENCH_PDICT = OrderedDict(
    frac_quench_cen_x0=11.956,
    frac_quench_cen_k=3.627,
    frac_quench_cen_ylo=0.014,
    frac_quench_cen_yhi=0.995,
    frac_quench_sat_x0=11.956,
    frac_quench_sat_k=3.627,
    frac_quench_sat_ylo=0.014,
    frac_quench_sat_yhi=0.995,
)
