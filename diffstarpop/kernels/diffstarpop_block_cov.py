...
from .qseq_massonly_block_cov import _qseq_pdf_scalar_kernel
...
def mc_diffstar_u_params_singlegal_kernel(ms_params, qseq_params, mah_params, ran_key):
    ...
    return u_params_ms, u_params_qseq, frac_quench, mc_is_quenched_sequence
