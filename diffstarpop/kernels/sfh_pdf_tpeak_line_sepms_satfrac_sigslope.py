...
SFH_PDF_QUENCH_MU_PDICT = OrderedDict(
    mean_ulgm_mseq_xtp=12.619,
    mean_ulgm_mseq_ytp=12.235,
    mean_ulgm_mseq_lo=0.512,
    mean_ulgm_mseq_hi=-0.015,
    mean_ulgy_mseq_int=-0.190,
    mean_ulgy_mseq_slp=0.581,
    mean_ul_mseq_int=-0.399,
    mean_ul_mseq_slp=1.581,
    mean_utau_mseq_int=-1.498,
    mean_utau_mseq_slp=-10.950,
    mean_ulgm_qseq_xtp=12.619,
    mean_ulgm_qseq_ytp=12.235,
    mean_ulgm_qseq_lo=0.512,
    mean_ulgm_qseq_hi=-0.015,
    mean_ulgy_qseq_int=0.112,
    mean_ulgy_qseq_slp=-0.379,
    mean_ul_qseq_int=-0.016,
    mean_ul_qseq_slp=0.804,
    mean_utau_qseq_int=3.603,
    mean_utau_qseq_slp=-7.789,
    mean_uqt_int=0.899,
    mean_uqt_slp=-0.350,
    mean_uqs_int=-0.294,
    mean_uqs_slp=0.158,
    mean_udrop_int=-2.257,
    mean_udrop_slp=-2.944,
    mean_urej_int=-1.304,
    mean_urej_slp=0.433,
)
...
SFH_PDF_QUENCH_COV_MS_BLOCK_PDICT = OrderedDict(
    ...
    std_utau_mseq_int=5.543,
    std_utau_mseq_slp=1.540,
    ...
    std_utau_qseq_int=3.883,
    std_utau_qseq_slp=1.963,
)
...
SFH_PDF_FRAC_QUENCH_PDICT = OrderedDict(
    frac_quench_cen_x0=11.565,
    frac_quench_cen_k=3.848,
    frac_quench_cen_ylo=0.037,
    frac_quench_cen_yhi=0.971,
    frac_quench_sat_x0=12.307,
    frac_quench_sat_k=2.825,
    frac_quench_sat_ylo=0.051,
    frac_quench_sat_yhi=0.973,
)
