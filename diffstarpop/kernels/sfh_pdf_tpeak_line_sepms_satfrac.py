...
SFH_PDF_QUENCH_MU_PDICT = OrderedDict(
    mean_ulgm_mseq_int=12.16,
    mean_ulgm_mseq_slp=0.11,
    mean_ulgy_mseq_int=-0.04,
    mean_ulgy_mseq_slp=-0.17,
    mean_ul_mseq_int=0.09,
    mean_ul_mseq_slp=0.22,
    mean_utau_mseq_int=1.36,
    mean_utau_mseq_slp=-12.57,
    mean_ulgm_qseq_int=12.16,
    mean_ulgm_qseq_slp=0.11,
    mean_ulgy_qseq_int=-0.04,
    mean_ulgy_qseq_slp=-0.17,
    mean_ul_qseq_int=0.09,
    mean_ul_qseq_slp=0.22,
    mean_utau_qseq_int=1.36,
    mean_utau_qseq_slp=-12.57,
    mean_uqt_int=0.93,
    mean_uqt_slp=-0.19,
    mean_uqs_int=-0.36,
    mean_uqs_slp=0.68,
...
SFH_PDF_QUENCH_COV_MS_BLOCK_PDICT = OrderedDict(
    std_ulgm_mseq_int=0.22,
    std_ulgm_mseq_slp=0.11,
    std_ulgy_mseq_int=0.32,
    std_ulgy_mseq_slp=0.03,
    std_ul_mseq_int=0.32,
    std_ul_mseq_slp=0.10,
    std_utau_mseq_int=6.85,
    std_utau_mseq_slp=0.96,
    std_ulgm_qseq_int=0.22,
    std_ulgm_qseq_slp=0.11,
    std_ulgy_qseq_int=0.32,
    std_ulgy_qseq_slp=0.03,
    std_ul_qseq_int=0.32,
    std_ul_qseq_slp=0.10,
    std_utau_qseq_int=6.85,
    std_utau_qseq_slp=0.96,
)
...
SFH_PDF_FRAC_QUENCH_PDICT = OrderedDict(
    frac_quench_cen_x0=12.07,
    frac_quench_cen_k=2.87,
    frac_quench_cen_ylo=0.05,
    frac_quench_cen_yhi=0.95,
    frac_quench_sat_x0=12.07,
    frac_quench_sat_k=2.87,
    frac_quench_sat_ylo=0.05,
    frac_quench_sat_yhi=0.95,
)
...
def _sfh_pdf_scalar_kernel(params, logmp0):
    frac_quench_cen = _frac_quench_cen_vs_logmp0(params, logmp0)
    frac_quench_sat = _frac_quench_sat_vs_logmp0(params, logmp0)
...
@jjit
def _frac_quench_cen_vs_logmp0(params, logmp0):
    frac_q_cen = _sigmoid(
        logmp0,
        params.frac_quench_cen_x0,
        params.frac_quench_cen_k,
        params.frac_quench_cen_ylo,
...
@jjit
def _frac_quench_sat_vs_logmp0(params, logmp0):
    frac_q_sat = _sigmoid(
        logmp0,
        params.frac_quench_sat_x0,
        params.frac_quench_sat_k,
        params.frac_quench_sat_ylo,
