...
from diffstarpop.mc_diffstarpop_tpeak_sepms_satfrac_sigslope_tpeak import (
    mc_diffstar_sfh_galpop,
)
from diffstarpop.loss_kernels.namedtuple_utils_tpeak_sepms_satfrac_sigslope_tpeak import (
    tuple_to_array,
    register_tuple_new_diffstarpop_tpeak,
    array_to_tuple_new_diffstarpop_tpeak,
)
from diffstarpop.kernels.defaults_tpeak_line_sepms_satfrac_sigslope_tpeak import (
    DEFAULT_DIFFSTARPOP_U_PARAMS,
    DEFAULT_DIFFSTARPOP_PARAMS,
    get_bounded_diffstarpop_params,
)
from fit_get_loss_helpers_sepms_satfrac_sigslope_galac_inplusexsitu import (
    get_loss_data_smhm,
...
from diffstarpop.loss_kernels.mstar_ssfr_loss_tpeak_sepms_satfrac_sigslope_tpeak import (
...
if __name__ == "__main__":
    ...
    legend_elements = [
        ...
        Patch(
            ...
            edgecolor="none",
            label=r"$M_\star(t_{\rm obs})=10.5$",
            alpha=0.7,
        ),
        Line2D([0], [0], color="k", ls="--", label="Diffstarpop"),
    ]
